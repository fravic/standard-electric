...
// node_modules/zustand/node_modules/react/cjs/react.development.js
var require_react_development = __commonJS({
  "node_modules/zustand/node_modules/react/cjs/react.development.js"(exports, module) {
    "use strict";
    (function() {
...
// node_modules/zustand/node_modules/react/index.js
var require_react2 = __commonJS({
  "node_modules/zustand/node_modules/react/index.js"(exports, module) {
    "use strict";
    if (false) {
      module.exports = null;
    } else {
...
// node_modules/actor-kit/dist/react.js
...
// node_modules/xstate/dist/raise-c17ec2bc.esm.js
var Mailbox = class {
...
"use client";
function m(e2) {
  let t2 = e2.initialSnapshot, r2 = null;
  const n2 = /* @__PURE__ */ new Set();
  let o2 = 0;
  const c2 = async () => {
    const s3 = function(e3) {
      const { host: t3, actorId: r3, actorType: n3, accessToken: o3, checksum: c3 } = e3, s4 = `${/^(localhost|127\.0\.0\.1|192\.168\.|10\.|172\.(1[6-9]|2[0-9]|3[0-1])\.)/.test(t3) ? "ws" : "wss"}://${t3}/api/${n3}/${r3}`, i2 = new URLSearchParams({ accessToken: o3 });
      c3 && i2.append("checksum", c3);
      return `${s4}?${i2.toString()}`;
    }(e2);
    return r2 = new WebSocket(s3), r2.addEventListener("open", () => {
      o2 = 0;
    }), r2.addEventListener("message", (r3) => {
      try {
        const o3 = JSON.parse("string" == typeof r3.data ? r3.data : new TextDecoder().decode(r3.data));
        t2 = produce(t2, (e3) => {
          applyPatch(e3, o3.operations);
        }), e2.onStateChange?.(t2), n2.forEach((e3) => e3(t2));
      } catch (t3) {
        console.error("[ActorKitClient] Error processing message:", t3), e2.onError?.(t3);
      }
    }), r2.addEventListener("error", (t3) => {
      console.error("[ActorKitClient] WebSocket error:", t3), console.error("[ActorKitClient] Error details:", { message: t3.message, type: t3.type, target: t3.target, eventPhase: t3.eventPhase }), e2.onError?.(new Error(`WebSocket error: ${JSON.stringify(t3)}`));
    }), r2.addEventListener("close", (e3) => {
      if (o2 < 5) {
        o2++;
        const e4 = Math.min(1e3 * Math.pow(2, o2), 3e4);
        setTimeout(c2, e4);
      } else
        console.error("[ActorKitClient] Max reconnection attempts reached");
    }), new Promise((e3) => {
      r2.addEventListener("open", () => e3());
    });
  }, s2 = (e3) => (n2.add(e3), () => {
    n2.delete(e3);
  });
  return { connect: c2, disconnect: () => {
    r2 && (r2.close(), r2 = null);
  }, send: (t3) => {
    r2 && r2.readyState === WebSocket.OPEN ? r2.send(JSON.stringify(t3)) : e2.onError?.(new Error("Cannot send event: WebSocket is not connected"));
  }, getState: () => t2, subscribe: s2, waitFor: async (e3, r3 = 5e3) => e3(t2) ? Promise.resolve() : new Promise((t3, n3) => {
    let o3 = null;
    r3 > 0 && (o3 = setTimeout(() => {
      c3(), n3(new Error(`Timeout waiting for condition after ${r3}ms`));
    }, r3));
    const c3 = s2((r4) => {
      e3(r4) && (o3 && clearTimeout(o3), c3(), t3());
    });
  }) };
}
function h(u) {
  const d = (0, import_react.createContext)(null), h2 = (0, import_react.memo)((t2) => {
    const r2 = (0, import_react.useRef)(m({ host: t2.host, actorId: t2.actorId, accessToken: t2.accessToken, checksum: t2.checksum, initialSnapshot: t2.initialSnapshot, actorType: u })), c2 = (0, import_react.useRef)(false);
    return (0, import_react.useEffect)(() => {
      c2.current || (c2.current = true, r2.current.connect().then(() => {
      }));
    }, [c2]), import_react.default.createElement(d.Provider, { value: r2.current }, t2.children);
  });
  function f() {
  ...
  const v = (e2) => {
    const t2 = f();
    return function(e3, t3, r2, n2, o2) {
      const [c2, l] = (0, import_react.useMemo)(() => {
        let e4, c3, s2 = false;
        const i2 = (t4) => {
          if (!s2)
            return s2 = true, e4 = t4, c3 = n2(t4), c3;
          if (Object.is(e4, t4))
            return c3;
          const r3 = n2(t4);
          return o2 && o2(c3, r3) ? (e4 = t4, c3) : (e4 = t4, c3 = r3, r3);
        };
        return [() => i2(t3()), r2 ? () => i2(r2()) : void 0];
      }, [t3, r2, n2, o2]), u2 = (0, import_react.useCallback)((t4) => {
        let r3 = c2();
        return e3(() => {
          const e4 = c2();
          o2 && o2(r3, e4) || (r3 = e4, t4());
        });
      }, [e3, c2, o2]);
      return (0, import_react.useSyncExternalStore)(u2, c2, l);
    }(t2.subscribe, t2.getState, t2.getState, e2, p);
  };
  function S(e2) {
    return v((t2) => matchesState(e2, t2.value));
  }
  const E = (t2) => {
    const r2 = S(t2.state), n2 = !t2.and || S(t2.and), o2 = !!t2.or && S(t2.or), c2 = "boolean" == typeof t2.initialValueOverride ? t2.initialValueOverride : r2 && n2 || o2;
    return (t2.not ? !c2 : c2) ? import_react.default.createElement(import_react.default.Fragment, null, t2.children) : null;
  };
  return E.create = (t2, r2 = {}) => {
    const n2 = ({ children: n3, initialValueOverride: o2 }) => import_react.default.createElement(E, { state: t2, and: r2.and, or: r2.or, not: r2.not, initialValueOverride: o2 }, n3);
    return n2.displayName = `MatchesComponent(${t2.toString()})`, n2;
  }, { Provider: h2, ProviderFromClient: ({ children: t2, client: r2 }) => import_react.default.createElement(d.Provider, { value: r2 }, t2), useClient: f, useSelector: v, useSend: function() {
    return f().send;
  }, useMatches: S, Matches: E };
}
function p(e2, t2) {
  return e2 === t2;
}

// app/actor/game.context.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/actor/game.context.ts"
  );
  import.meta.hot.lastModified = "1737383191743.8345";
}
var GameContext = h("game");
var GameProvider = GameContext.Provider;
...
// app/lib/clientState/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/lib/clientState/index.ts"
  );
  import.meta.hot.lastModified = "1737384973771.457";
}
var setIsDebug = (set2) => (isDebug) => {
  set2(
    (state) => {
...
var setPaintbrushMode = (set2) => (enabled) => {
  set2(
    (state) => {
...
var setSelectedTerrainType = (set2) => (terrainType) => {
  set2(
    (state) => {
...
var setSelectedPopulation = (set2) => (population) => {
  set2(
    (state) => {
...
var setHoverLocation = (set2) => (worldPoint) => {
  set2(
    (state) => {
...
var selectHex = (set2) => (coordinates) => {
  set2(
    (state) => {
...
var useClientStore = create()(
  devtools(
    immer2((set2) => ({
      ...
      setIsDebug: setIsDebug(set2),
      setPaintbrushMode: setPaintbrushMode(set2),
      setSelectedTerrainType: setSelectedTerrainType(set2),
      setSelectedPopulation: setSelectedPopulation(set2),
      setBuildMode: setBuildMode(set2),
      setHoverLocation: setHoverLocation(set2),
      selectHex: selectHex(set2)
    }))
  )
);
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/components/Game.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1737385061521.9365";
}
function Game() {
  _s();
  const isDebug = useClientStore((state2) => state2.isDebug);
  const state = GameContext.useSelector((state2) => state2);
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { style: {
    ...
    fileName: "app/components/Game.tsx",
    lineNumber: 36,
    columnNumber: 10
  }, this);
}
_s(Game, "Y8RpgEnpwZTGRS2zGxwRiBhh7wY=", false, function() {
  return [useClientStore, GameContext.useSelector];
});
_c = Game;
var _c;
$RefreshReg$(_c, "Game");
  ...
  strict(message) {
    ...
    return new ZodObject({
      ...
      ...message !== void 0 ? {
        errorMap: (issue, ctx) => {
          var _a, _b, _c3, _d;
          const defaultError = (_c3 = (_b = (_a = this._def).errorMap) === null || _b === void 0 ? void 0 : _b.call(_a, issue, ctx).message) !== null && _c3 !== void 0 ? _c3 : ctx.defaultError;
...
// node_modules/actor-kit/src/schemas.ts
var BotManagementSchema = z.object({
...
var CallerSchema = z.object({
  id: z.string(),
  type: z.enum(["client", "system", "service"])
});
var AnyEventSchema = z.object({
  type: z.string()
});
var SystemEventSchema = z.discriminatedUnion("type", [
  z.object({
...
var CallerIdTypeSchema = z.enum(["client", "service", "system"]);
var CallerStringSchema = z.string().transform((val, ctx) => {
  if (val === "anonymous") {
    return { type: "client", id: "anonymous" };
  }
...
// node_modules/actor-kit/src/createActorFetch.ts
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/routes/games.$gameId.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1737383951410.2837";
}
function GameRoute() {
  _s2();
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(GameProvider, { host, actorId: gameId, accessToken, checksum: payload.checksum, initialSnapshot: payload.snapshot, children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(Game, {}, void 0, false, {
    fileName: "app/routes/games.$gameId.tsx",
    lineNumber: 64,
    columnNumber: 7
  }, this) }, void 0, false, {
    fileName: "app/routes/games.$gameId.tsx",
...
_s2(GameRoute, "2KPy0CiCYnJ7CGCY7Ga1j4qNo+Q=", false, function() {
  return [useParams, useLoaderData];
});
_c2 = GameRoute;
var _c2;
$RefreshReg$(_c2, "GameRoute");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
export {
...
fast-json-patch/module/duplex.mjs:
   ...
   *)
*/
//# sourceMappingURL=/dist/routes/games.$gameId-2WOZVRGI.js.map
