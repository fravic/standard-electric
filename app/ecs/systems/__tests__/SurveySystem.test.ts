...
describe("SurveySystem", () => {
  ...
  beforeEach(() => {
    ...
    hexGrid.cellsByHexCoordinates[coordinatesToString(mountainCoord)] = createHexCell(
      mountainCoord,
      TerrainType.Mountains
    );
    hexGrid.cellsByHexCoordinates[coordinatesToString(forestCoord)] = createHexCell(
      forestCoord,
      TerrainType.Forest
    );
    hexGrid.cellsByHexCoordinates[coordinatesToString(plainsCoord)] = createHexCell(
      plainsCoord,
      TerrainType.Plains
    );
